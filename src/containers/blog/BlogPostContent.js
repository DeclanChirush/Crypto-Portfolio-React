    ...
    useEffect(() => {
        async function dataFetch() {
            await NewsService.getAllNews()
                ...
                .then((data) => {
                    setNewsList(data.filter(news => news._id.$oid === id));
                    ...
                    <div className="col-lg-8 col-md-12 col-sm-12 col-12">
                        <div className="dg__blog__details right--sidebar">
                            <div className="dg__blog__dtl">
                                <div className="thumb">
                                    {
                                        newsList && newsList.map((single, key) => {
                                            if (single._id.$oid === id) {
                                                return <img src={process.env.PUBLIC_URL + single.image} alt="blog images"
                                                            key={key}/>
                                            }
                                        })
                                    }
